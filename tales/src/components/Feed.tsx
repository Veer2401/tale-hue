  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6">
      ...
      <a 
        ...
        className="block mb-6 glass rounded-2xl p-4 md:p-5 border border-pink-500/30 hover:border-pink-500 transition-all transform hover:scale-105 group neon-glow"
      >
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <p className="font-black text-white text-base md:text-lg flex items-center gap-2">
                Follow @talehue
                <span className="text-xs md:text-sm px-2 py-0.5 bg-pink-500/20 rounded-full text-pink-400 font-bold">New!</span>
              </p>
              <p className="text-purple-200 text-xs md:text-sm font-medium">Join the vibe on Instagram 🔥</p>
            </div>
          </div>
          <div className="hidden sm:block">
            <div className="px-4 md:px-6 py-2 md:py-2.5 bg-gradient-to-r from-pink-600 to-purple-600 text-white font-black text-sm md:text-base rounded-full group-hover:shadow-xl transition-all">
              Follow
            </div>
          </div>
        </div>
